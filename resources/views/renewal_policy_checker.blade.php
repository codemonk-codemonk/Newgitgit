...
<!---Calender Script--->
  ...
  <tr>
    ...
    <!--Calender--->
    <td><input id="year" name="purchaseyear" type="text" value="{{$post->purchasingdate}}" readonly></td>
</tr>
...
let veh="";
  function solve()
      {
      //var y={{$year = Carbon\Carbon::createFromFormat('Y-m-d',$post->start)->year}}
      var y={{$post->purchasingdate}};
